...
/** Start a new schema with one blank field; examples belong in UI placeholders. */
export function emptySchemaDraft(uid: () => string): SchemaDraft {
  return { name: "", description: "", fields: [emptyField(uid())] };
}
